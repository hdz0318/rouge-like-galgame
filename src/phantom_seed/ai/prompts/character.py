...
{{
  ...
  "visual_description": "英文外貌描述用于AI绘图：an attractive adult university student woman, hair color/style, eye color, casual stylish clothing (NOT a school uniform, NOT sailor uniform), distinguishing features, overall aesthetic（25-40英文词）",
